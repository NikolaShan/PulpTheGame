...
class CC_DLL CCBMemberVariableAssigner {
    public:
         ...
         */
    virtual bool onAssignCCBMemberVariable(cocos2d::Ref* target, const std::string &memberVariableName, cocos2d::Node* node) = 0;
         ...
         *  @return Whether the assignment was successful.
         */
        virtual bool onAssignCCBCustomProperty(cocos2d::Ref* target, const std::string &memberVariableName, const cocos2d::Value& value) { return false; };
};
