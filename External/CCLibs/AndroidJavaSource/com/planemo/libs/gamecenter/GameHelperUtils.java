...
class GameHelperUtils {
    ...
    private final static String[] RES_IDS = {
            "Failed to sign in. Please check your network connection and try again.",
            "The application is incorrectly configured. Check that the package name and signing certificate match the client ID " +
                    "created in Developer Console. Also, if the application is not yet published, check that the account " +
                    "you are trying to sign in with is listed as a tester account. See logs for more information.",
            "License check failed.",
            "Unknown error."
    };
